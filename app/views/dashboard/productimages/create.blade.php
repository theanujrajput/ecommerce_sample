...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#form").validate({
            rules: {
                file: {"required": true, extension: "jpeg,jpg,png" }
            }
        });
    ...
    <div class="col-lg-10">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form">
                    <form action="{{URL::to('dashboard/product-images/create/'.$product->id)}}"
                        ...
                        <div class="form-group ">
                            <label for="caption" class="control-label col-lg-3">Caption *</label>

                            <div class="col-lg-6">
                                <input name="caption" type="text" class="required form-control" id="caption"
                                       value="{{Input::old('caption')}}"/>
                        ...
                        <div class="form-group">
                            <label for="active" class="control-label col-lg-3">Is Primary ?</label>

                            <div class="col-lg-3">
                                <div class="radio">
                                    <input type="radio" class="" name="primary" value="1"/>Yes
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="radio">
                                    <input type="radio" class="" name="primary" value="0"/>No
                                </div>
                            </div>
                            <span class="error">{{$errors->first('primary')}}</span>
                        </div>

                        <div class="form-group">
                            <label for="active" class="control-label col-lg-3">Upload Image*</label>

                            <div class="col-lg-6">
                                <input type="file" name="img" id="img" class="required"/>
                            </div>
