...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#form").validate({
            rules: {
                file: {extension: "pdf,doc,docx,csv,txt" }
            }
        });
    ...
    <div class="col-lg-10">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form">
                    <form action="{{URL::to('dashboard/product-documents/edit/'.$product->id.'/'.$document->id)}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <textarea name="notes" id="notes" rows="6"
                                          class="form-control">{{$document->notes}}</textarea>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="radio">
                                    <input type="radio" class="required" name="active" value="1"
                                        @if($document->active==1) checked @endif/>Yes
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="radio">
                                    <input type="radio" class="required" name="active" value="0"
                                        @if($document->active==0) checked @endif/>No
                                </div>
                            </div>
