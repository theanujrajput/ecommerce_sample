    ...
    <div class="col-lg-10">
        ...
        <div class="panel">
            <div class="panel-heading">
                Documents
                <a href="{{URL::to('dashboard/product-documents/create/'.$product->id)}}"
                ...
                <table class="table  table-hover general-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{URL::to('dashboard/product-documents/activate-or-deactivate/'.$product->id.'/'.$document->id.'/0')}}">
                                <i class="fa fa-check green"></i>
                            </a>
                            @else
                            <a href="{{URL::to('dashboard/product-documents/activate-or-deactivate/'.$product->id.'/'.$document->id.'/1')}}">
                        ...
                        <td>
                            <a class="btn btn-xs btn-info"
                               href="{{URL::to('dashboard/product-documents/edit/'.$product->id.'/'.$document->id)}}">
                                <i class="fa fa-pencil"></i></a>
                            <a class="btn btn-xs btn-danger"
                               href="{{URL::to('dashboard/product-documents/delete/'.$product->id.'/'.$document->id)}}"><i
