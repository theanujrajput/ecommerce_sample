...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL::to('dashboard/category')}}"></a>Category</li>
            <li>Videos</li>
        </ul>
        <!--breadcrumbs end -->
    </div>
    ...
    <div class="col-lg-10">
        ...
        <div class="panel">
            <div class="panel-heading">
                Videos
                <a href="{{URL::to('dashboard/category-videos/create/'.$category->id)}}"
            ...
            <div class="panel-body">
                ...
                <table class="table  table-hover general-table">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($video->active==1)
                            <a href="{{URL::to('dashboard/category-videos/activate-or-deactivate/'.$video->id.'/0')}}">
                                <i class="fa fa-check green"></i>
                            </a>
                            @else
                            <a href="{{URL::to('dashboard/category-videos/activate-or-deactivate/'.$video->id.'/1')}}">
                        ...
                        <td>
                            <a class="btn btn-xs btn-info"
                               href="{{URL::to('dashboard/category-videos/edit/'.$category->id.'/'.$video->id)}}">
                                <i class="fa fa-pencil"></i></a>
                            <a class="btn btn-xs btn-danger" href="{{URL::to('dashboard/category-video')}}"><i
