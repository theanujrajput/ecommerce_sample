        ...
        <div class="row-fluid">
            <section id="center_column" class="span12">
                <div class="contenttop row-fluid">
                    ...
                    <h1 id="cart_title" class="title_category custom_h1">Cart Summary</h1>
                    ...
                    <div id="order-detail-content" class="table_block">
                        <table id="cart_summary" class="std">
                            ...
                            <tr id="product_4_0_0_0" class="cart_item first_item address_0 odd">
                                ...
                                <td class="cart_delete">
                                    <div>
                                        <a href="{{URL::to('cart/remove-item/'.$type.'/'.$id.'?redirect=true')}}"
                        ...
                        <div class="clearfix row-fluid" id="customer_cart_total">
                            <div class="span12">
                                ...
                                <!--                                            alert to +91 <input id="" size="10" type="text" name="phone" class=""-->
                                <!--                                                                maxlength="10" value="9988774411">-->
                                <!--                                        </fieldset>-->
                                <!--                                    </form>-->
                                <!--                                </div>-->
                                <div class="" style="display:inline-block; float:right">
                                    <a href="{{URL::to('/user/address')}}"
